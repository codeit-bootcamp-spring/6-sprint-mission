...
import com.sprint.mission.discodeit.event.event.UserUpdatedEvent.UserNotificationType;
...
public class RedisJwtRegistry implements JwtRegistry {
  ...
  public void registerJwtInformation(JwtInformation jwtInformation) {
    String userKey = getUserKey(jwtInformation.getUser().getId());
    String lockKey = jwtInformation.getUser().getId().toString();
    ...
    eventPublisher.publishEvent(
        UserUpdatedEvent.of(
            jwtInformation.getUser().getId(),
            UserNotificationType.UPDATED,
            jwtInformation.getUser())
    );
  }
  ...
  public void rotateJwtInformation(String refreshToken, JwtInformation newJwtInformation) {
    String userKey = getUserKey(newJwtInformation.getUser().getId());
    String lockKey = newJwtInformation.getUser().getId().toString();
