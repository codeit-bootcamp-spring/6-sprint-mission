...
public class NotificationRequiredTopicListener {
  ...
  @KafkaListener(topics = "discodeit.MessageCreatedEvent", groupId = "discodeit-notification")
  ...
  @KafkaListener(topics = "discodeit.RoleUpdatedEvent", groupId = "discodeit-notification")
  ...
  @KafkaListener(topics = "discodeit.S3UploadFailedEvent", groupId = "discodeit-notification")
