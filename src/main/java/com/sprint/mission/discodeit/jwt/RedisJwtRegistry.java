...
public class RedisJwtRegistry implements JwtRegistry {
    ...
    public void registerJwtInformation(JwtInformation jwtInformation) {
        String userKey = getUserKey(jwtInformation.getDto().userDto().id());
        String lockKey = jwtInformation.getDto().userDto().id().toString();
        ...
        eventPublisher.publishEvent(
                new UserLogInOutEvent(jwtInformation.getDto().userDto().id().toString(), true)
        );
    }
    ...
    public void invalidateJwtInformationByUserId(String userId) {
        String userKey = USER_JWT_KEY_PREFIX + userId;
    ...
    public void rotateJwtInformation(String refreshToken, JwtInformation newJwtInformation) {
        String userKey = getUserKey(newJwtInformation.getDto().userDto().id());
        String lockKey = newJwtInformation.getDto().userDto().id().toString();
