...
public class ReadStatusController implements ReadStatusApi {
    ...
    @GetMapping
    public ResponseEntity<List<ReadStatusDto>> findAllByUserId(@AuthenticationPrincipal DiscodeitUserDetails userDetails) {
        log.info("사용자별 읽음 상태 목록 조회 요청: userId={}", userDetails.getUserDto().id());
        List<ReadStatusDto> readStatuses = readStatusService.findAllByUserId(userDetails);
