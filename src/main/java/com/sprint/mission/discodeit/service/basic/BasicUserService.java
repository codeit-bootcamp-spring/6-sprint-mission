...
public class BasicUserService implements UserService {
    ...
    @Caching(
            evict = @CacheEvict(value = CacheNames.USER_LIST, allEntries = true),
        ...
        BinaryContent nullableProfile = optionalProfileCreateRequest
                .map(profileRequest -> {
                    ...
                    applicationEventPublisher.publishEvent(new BinaryContentCreatedEvent(
                            savedBinaryContent.getId(), bytes, binaryContentStorage
                    ));
//          binaryContentStorage.put(binaryContent.getId(), bytes);
    ...
    @Cacheable(value = CacheNames.USER_LIST)
    @Transactional(readOnly = true)
    @Override
...
//                    binaryContentStorage.put(binaryContent.getId(), bytes);
    ...
    @Caching(evict = {
            ...
            @CacheEvict(value = CacheNames.USER, key = "#userId")
    })
    @PreAuthorize("principal.userDto.id == #userId")
    @Transactional
    @Override
