...
public class BasicChannelService implements ChannelService {
  ...
  public ChannelDto create(PublicChannelCreateRequest request) {
    ...
    eventPublisher.publishEvent(new SseDispatchEvent(null, "channels.created", dto));
    return dto;
  }
  ...
  public ChannelDto create(PrivateChannelCreateRequest request) {
    ...
    eventPublisher.publishEvent(
        new SseDispatchEvent(request.participantIds(), "channels.created", dto)
    );
    return dto;
  }
  ...
  public ChannelDto update(UUID channelId, PublicChannelUpdateRequest request) {
    ...
    ChannelDto dto = channelMapper.toDto(channel);
    eventPublisher.publishEvent(new SseDispatchEvent(null, "channels.updated", dto));
    return dto;
  }
  ...
  public void delete(UUID channelId) {
    ...
    Channel channel = channelRepository.findById(channelId)
        .orElseThrow(() -> ChannelNotFoundException.withId(channelId));
    ChannelDto dto = channelMapper.toDto(channel);
    List<UUID> receiverIds = channel.getType().equals(ChannelType.PRIVATE)
    ...
    eventPublisher.publishEvent(
        new SseDispatchEvent(receiverIds, "channels.deleted", dto)
    );
